...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.UserRole = field.NewInt64(tableName, "userRole")
	_user.IsDelete = field.NewInt64(tableName, "isDelete")
	_user.CreateTime = field.NewTime(tableName, "createTime")
...
func (u *user) updateTableName(table string) *user {
	...
	u.UserRole = field.NewInt64(table, "userRole")
	u.IsDelete = field.NewInt64(table, "isDelete")
