...
func newQuestion(db *gorm.DB, opts ...gen.DOOption) question {
	...
	_question.SubmitNum = field.NewInt64(tableName, "submitNum")
	_question.AcceptedNum = field.NewInt64(tableName, "acceptedNum")
	_question.JudgeCases = field.NewString(tableName, "judgeCases")
	_question.JudgeConfig = field.NewString(tableName, "judgeConfig")
	_question.UserID = field.NewInt64(tableName, "userId")
	_question.CreateTime = field.NewTime(tableName, "createTime")
	_question.UpdateTime = field.NewTime(tableName, "updateTime")
	_question.IsDelete = field.NewInt64(tableName, "isDelete")
...
type question struct {
	...
	SubmitNum   field.Int64  // 题目提交数
	AcceptedNum field.Int64  // 题目通过数
	JudgeCases  field.String // 判题用例（json 数组）
...
func (q *question) updateTableName(table string) *question {
	...
	q.SubmitNum = field.NewInt64(table, "submitNum")
	q.AcceptedNum = field.NewInt64(table, "acceptedNum")
	q.JudgeCases = field.NewString(table, "judgeCases")
...
func (q *question) fillFieldMap() {
	...
	q.fieldMap["judgeCases"] = q.JudgeCases
