...
const (
	Judge_DoJudge_FullMethodName = "/pb.judge/doJudge"
)
...
func (c *judgeClient) DoJudge(ctx context.Context, in *JudgeReq, opts ...grpc.CallOption) (*JudgeResp, error) {
	out := new(JudgeResp)
	err := c.cc.Invoke(ctx, Judge_DoJudge_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type JudgeServer interface {
	DoJudge(context.Context, *JudgeReq) (*JudgeResp, error)
...
func (UnimplementedJudgeServer) DoJudge(context.Context, *JudgeReq) (*JudgeResp, error) {
...
func _Judge_DoJudge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(JudgeReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(JudgeServer).DoJudge(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Judge_DoJudge_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JudgeServer).DoJudge(ctx, req.(*JudgeReq))
	}
...
var Judge_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "doJudge",
			Handler:    _Judge_DoJudge_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pb/judge.proto",
}
